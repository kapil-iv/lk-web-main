            ...
            apiCategories.map((category, index) => {
              ...
              return (
                <motion.button
                  ...
                  className={`flex-shrink-0 flex flex-col items-center p-2 sm:p-3 md:p-4 rounded-lg sm:rounded-xl border-2 transition-all duration-300 min-w-[90px] sm:min-w-[100px] md:min-w-[120px] mx-1 ${isSelected
                ...
                >
                  ...
                  <span className={`text-[11px] sm:text-xs md:text-sm font-medium text-center leading-tight ${isSelected ? 'text-brand-secondary' : 'text-gray-700'
                    }`}>
                    {category.name}
                  </span>
                </motion.button>
