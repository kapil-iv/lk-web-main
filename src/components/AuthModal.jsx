...
import { registerUser } from '../api/apiUtils';
import LKLogo from '../assets/images/LKlogo1.png';
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        // Assuming registration sends OTP, proceed to OTP step
        setStep('otp');
        setIsSignUp(false);
        setCountdown(120);
      ...
      {isAuthModalOpen && (
        ...
        >
          ...
          >
            ...
            {/* Branded Header */}
            <div className="relative p-8 bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50 text-center">
              <div className="flex items-center justify-center mb-2">
                <img src={LKLogo} alt="LocalKonnect" className="h-16 w-auto object-contain" />
              </div>
              <p className="mt-3 text-gray-600">Experience the best in Salon, Sports, and Events.</p>
            </div>
                  ...
                  >
                    {!isSignUp ? (
                      ...
                      <>
                        ...
                        <p className="text-center text-gray-500 mt-2">Login to access your account</p>
                      ...
                      <>
                        ...
                        <p className="text-center text-gray-500 mt-2">Join us to explore events!</p>
                        <form onSubmit={handleRegister} className="mt-6 space-y-4">
                          <div>
                            <input
                              ...
                              className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-secondary focus:border-transparent"
                              required
                            />
                          </div>

                          <div className="flex items-center border border-gray-300 rounded-lg focus-within:ring-2 focus-within:ring-brand-secondary focus-within:border-transparent">
                            <div className="flex items-center pl-3 pr-2 border-r bg-gray-50 rounded-l-lg">
                              <span role="img" aria-label="India flag">🇮🇳</span>
                              <span className="ml-2 font-medium text-gray-700">+91</span>
                            </div>
                            <input
                          ...
                          <button
                            type="submit"
                            className="w-full mt-4 bg-brand-primary text-white py-3 rounded-lg font-semibold hover:bg-brand-secondary transition-colors flex items-center justify-center bg-gray-900"
                            disabled={isLoading}
                          >
                            {isLoading ? (
                              <>
