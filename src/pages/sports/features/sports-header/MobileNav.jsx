...
const MobileNav = () => {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 w-full bg-white z-50 h-16 transition-colors duration-300 shadow-[0_-4px_20px_rgba(0,0,0,0.4)]">
      <div className="flex justify-around items-center h-full">
        ...
        <NavLink
          ...
          className={({ isActive }) => `${linkStyles} ${isActive ? activeStyles : inactiveStyles}`}
        >
          <Home size={18} />
