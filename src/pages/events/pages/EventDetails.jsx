...
const EventDetails = () => {
    ...
    const fetchEvent = async () => {
      try {
        ...
        setEvent({
          id: data.id,
          title: data.name,
          image: attrMap["event_files"] ? [attrMap["event_files"]] : [],
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 pt-4 md:pt-6 pb-24 md:pb-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-4">
          ...
          <div className="lg:col-span-2">
            ...
            <motion.div
              ...
              className="relative overflow-hidden mb-6 rounded-none lg:rounded-xl bg-black/5"
            >
              <img src={event.image} alt={event.title} className="w-full h-auto max-h-[500px] object-contain mx-auto" />
            </motion.div>
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">{cleanLocationText(event.location?.address) || 'Venue details not available'}</p>
                      {event.location && (
                        <a
